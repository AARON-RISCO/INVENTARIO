...
<body>
    ...
    <div id="conteiner">
        <div class="listado">
        <div class="todos">
                    <label for="">Todas los cajas</label>
                    <div class="filtros">
                    <fieldset class="filtros_per">
                            ...
                            <div class="buscar_per"><input type="text" name="bus_nom" id="bus_nom" class="bus MT" placeholder="Buscar por Fecha"></div>
                    </fieldset>
                    </div>
                    <div id="listado"> 
                    <table >
       ...
       <!-- <div class="mantenimiento">
                <label>Mantenimiento caja</label><br>

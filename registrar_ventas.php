...
<body>
    ...
    <div class="modal">
        ...
        <input type="text" name="tnom_deu" id="tnom_deu" class="cajas_modal MAYP" placeholder="Ingrese Nombres"><br>
        <input type="text" name="tape_deu" id="tape_deu" class="cajas_modal MAYP" placeholder="Ingrese Apellidos"><br>
